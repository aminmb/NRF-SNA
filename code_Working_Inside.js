...
$('#cy').cytoscape({
  ...
  elements: {
    ...
    edges: [
      { data: { source: 'Jeanne', target: 'Asselin', faveColor: '#bf00ff', strength: 30 } },
      ...
      { data: { source: 'Jeanne', target: 'James', faveColor: '#86B342', strength: 130 } },
      { data: { source: 'Jeanne', target: 'Lush', faveColor: '#86B342', strength: 130 } },
      { data: { source: 'Jeanne', target: 'Saxton', faveColor: '#bf00ff', strength: 130 } },
      ...
      { data: { source: 'Jeanne', target: 'Young', faveColor: '#86B342', strength: 30 } },
      ...
      { data: { source: 'Jacqueline', target: 'Hage', faveColor: '#bf00ff', strength: 130 } },
      { data: { source: 'Jacqueline', target: 'James', faveColor: '#bf00ff', strength: 120 } },
      ...
      { data: { source: 'Jacqueline', target: 'Scholl', faveColor: '#bf00ff', strength: 130 } },
      { data: { source: 'Jacqueline', target: 'Shemet', faveColor: '#bf00ff', strength: 130 } },
      { data: { source: 'Jacqueline', target: 'Young', faveColor: '#bf00ff', strength: 30 } }
